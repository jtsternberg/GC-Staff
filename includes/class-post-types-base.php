<?php
/**
 * GC Staff Post Types Base
 *
 * @version 0.0.0
 * @package GC Staff
 */

abstract class GCST_Post_Types_Base extends CPT_Core {
	...
	public function filter_values() {
		...
		$filtered_args = apply_filters( 'gcst_post_types_'. $this->id, $args, $this );
	...
	public function new_cmb2( $args ) {
		$cmb_id = $args['id'];
		return new_cmb2_box( apply_filters( "gcst_cmb2_box_args_{$this->id}_{$cmb_id}", $args ) );
	}
